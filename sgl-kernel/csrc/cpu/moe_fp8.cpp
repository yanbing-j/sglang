  ...
  // at::parallel_for(0, MB * NB, 102400, [&](int64_t begin, int64_t end) {
    ...
    for (int64_t i = 0; i < MB * NB; ++i) {
      ...
      tinygemm_kernel<scalar_t, false>(
        /*   A                  */ A,
        /*   B                  */ packed_w1 + nb0 * BLOCK_N * stride_n,
        /*   C                  */ C0,// + mb * BLOCK_M * N + nb0 * BLOCK_N,
        /*   Btmp               */ Btmp,
        /*   Ctmp               */ Ctmp,
        /*   scale              */ scale_ptr_nb0,
        /*   bias               */ nullptr,
...
// // });
  ...
  // at::parallel_for(0, MB2 * NB2, 102400, [&](int64_t begin, int64_t end) {
    ...
    for (int64_t i = 0; i < MB2 * NB2; ++i) {
      ...
      tinygemm_kernel<scalar_t, false>(
        /*   A                  */ A,
        /*   B                  */ packed_w2 + nb * BLOCK_N * stride_oc,
        /*   C                  */ C2,// + mb * BLOCK_M * stride_oc + nb * BLOCK_N,
        /*   Btmp               */ Btmp2,
        /*   Ctmp               */ Ctmp2,
        /*   scale              */ scale_ptr_2,
        /*   bias               */ nullptr,
